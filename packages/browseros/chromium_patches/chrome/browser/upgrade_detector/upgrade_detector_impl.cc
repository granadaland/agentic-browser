...
index 15ca9a708125d..2169d39e8d68a 100644
...
@@ -68,7 +71,10 @@ constexpr auto kOutdatedBuildDetectorPeriod = base::Days(1);
...
@@ -157,6 +163,15 @@ void UpgradeDetectorImpl::CalculateThresholds() {
...
@@ -210,6 +225,7 @@ void UpgradeDetectorImpl::DoCalculateThresholds() {
...
@@ -275,6 +291,8 @@ void UpgradeDetectorImpl::DetectOutdatedInstall() {
...
@@ -327,6 +345,10 @@ void UpgradeDetectorImpl::NotifyOnUpgradeWithTimePassed(
...
@@ -485,7 +507,10 @@ void UpgradeDetectorImpl::Init() {
...
@@ -529,6 +554,9 @@ base::Time UpgradeDetectorImpl::GetAnnoyanceLevelDeadline(
